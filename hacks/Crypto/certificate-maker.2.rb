...
pkey_password = ""
subject = "/O=Honest Achmed's Used Cars and Certificates/CN=Geremia's cert"
expiry_years = 1
...
cert.extensions = [
	...
	extf.create_extension("nameConstraints", "permitted;DNS:google.com, permitted;DNS:gmail.com, excluded;DNS:blah.google.com", true)
